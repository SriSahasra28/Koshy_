...
var v = (s, t, i) =>
  t in s
    ? p(s, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
    : (s[t] = i);
...
class P {
  ...
  attached({ chart: t, series: i, requestUpdate: e }) {
    (this._chart = t),
      ...
      (this._requestUpdate = e),
      this.requestUpdate();
  }
  detached() {
    var t;
    (t = this._series) == null ||
      t.unsubscribeDataChanged(this._fireDataUpdated),
      (this._chart = void 0),
      (this._series = void 0),
...
function m(s, t, i = 1, e) {
  const o = Math.round(t * s),
    h = e ? i : Math.round(i * t),
    a = C(h);
  return { position: o - a, length: h };
}
function g(s, t, i) {
  const e = Math.round(i * s),
    o = Math.round(i * t);
  return {
...
const l = 21,
  w = "M7.5,7.5 m -7,0 a 7,7 0 1,0 14,0 a 7,7 0 1,0 -14,0 M4 7.5H11 M7.5 4V11",
  M = new Path2D(w),
  L = 15;
class U {
  constructor(t) {
    ...
    this._data.visible &&
      t.useBitmapCoordinateSpace((i) => {
        const e = i.context,
          ...
          n = m(this._data.y, i.verticalPixelRatio, o);
        e.fillStyle = this._data.color;
        const c = [5, 0, 0, 5].map((u) => u * i.horizontalPixelRatio);
        e.beginPath(),
          e.roundRect(a.position, n.position, a.length, n.length, c),
          e.fill(),
          this._data.hovered &&
            ((e.fillStyle = this._data.hoverColor),
            e.beginPath(),
            e.roundRect(a.position, n.position, a.length, n.length, c),
            e.fill()),
          e.translate(
            a.position + 3 * i.horizontalPixelRatio,
            n.position + 3 * i.verticalPixelRatio
          ),
          e.scale(i.horizontalPixelRatio, i.verticalPixelRatio);
        const d = 15 / L;
        e.scale(d, d),
          (e.strokeStyle = this._data.textColor),
          (e.lineWidth = 1),
          e.stroke(M);
      });
  }
...
class H {
  constructor(
    ...
    e,
    handleClick,
    handleShowAddOrderLineLabel,
    handleHideAddOrderLineLabel
  ) {
    r(this, "_chart");
    r(this, "_series");
    r(this, "_options");
    ...
    (this._chart = t),
      ...
      (this._labelButtonPrimitive = new y(this)),
      i.attachPrimitive(this._labelButtonPrimitive),
      this._setCrosshairMode();

    this.handleClick = handleClick;
    this.handleShowAddOrderLineLabel = handleShowAddOrderLineLabel;
    this.handleHideAddOrderLineLabel = handleHideAddOrderLineLabel;
  }
  currentLineColor() {
  ...
  _onMouseMove(t) {
    ...
    if (i === null || e === null || e > l * 2) {
      ...
      this.handleHideAddOrderLineLabel();
      return;
    }
    this._labelButtonPrimitive.showAddLabel(i, e < l);
    this.handleShowAddOrderLineLabel();
  }
  _getMousePrice(t) {
    return !t.point || !this._series
      ? null
      : this._series.coordinateToPrice(t.point.y);
  }
